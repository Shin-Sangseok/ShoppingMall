...
public class ProductListVO {
	...
	//팬츠, 가디건&풀오버, 데님/진, 드레스 , 맨투맨&후디 
	//블레이저, 셔츠&블라우스 , 쇼츠, 스커트, 재킷&코트, 탑&티셔츠 
	
	private String product_tag;
	private String product_like;
	private String product_description;
	private String product_rgstdate;          //timestamp ���� �� �� �Ѿ� ���� ��� ����. string���� ���� 
	private String product_mdfydate;	      //timestmap ���� �� �ȳѾ� ���� ��� ���� string���� ����
